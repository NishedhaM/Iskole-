...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="main-content">
            ...
            <form action="../admin_analytics/content_upload.php" method="post">
                <input type="hidden" name="view_id" value="<?php echo $id; ?>">
                <button type="submit" name="view_btn" class="button"> Content Upload</button>
            </form>
            <form action="../admin_analytics/quiz_upload.php" method="post">
                <input type="hidden" name="view_id" value="<?php echo $id; ?>">
                <button type="submit" name="view_btn" class="button"> Quiz Upload</button>
            </form>
            <form action="../admin_analytics/payment.php" method="post">
                <input type="hidden" name="view_id" value="<?php echo $id; ?>">
                <button type="submit" name="view_btn" class="button"> Payment</button>
            </form>
