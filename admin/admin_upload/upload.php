    ...
    <div class="sidebar">
        ...
        <div class="sidebar-main">
            <div class="sidebar-user">
                <a href="../admin_profile.php"><img src="../admin_images/teacher2.jpg"  alt=""></a>
                 <div>
         ...
         <div class="sidebar-menu">
               ...
               <ul>
                  ...
                  <li><a href="../admin_chat.php"><span class="las la-comments"></span>Chat</a></li>
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <div class="container">
                    ...
                    <a href="../admin_subjects/mathematics/grade1/subjectindex.php">Back</a>
                    <div class="upload">
