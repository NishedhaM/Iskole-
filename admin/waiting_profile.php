            ...
            <main>
                <div class="page-header">
                    <div class="dpandname">
                           ...
                           <img id="teacherprofile" src="admin_images/image.jpg">
                    ...
                    <div class="header-actions">
                      ...
                      <form action="reject.php" method="post">
                                              ...
                                              <button type="submit" name="reject_btn" class="hbtn hb-fill-right-rev-bg-br"><span class="fa fa-ban"> Reject</button>
                      </form>
