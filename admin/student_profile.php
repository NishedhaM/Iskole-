            ...
            <main>
                <div class="page-header">
                    <div class="dpandname">
                          ...
                          <!-- <a style="margin-right:1200px;" href="../mystudents/mystudents.php" class="hbtn hb-fill-right-rev-bg-br"><span class="las la-tools"></span>Back</a> -->

                    </div>
                    <div class="header-actions">
                        <form action="./restrict1.php" method="post">
                                              <input type="hidden" name="restrict_id" value="<?php echo $stu_id; ?>">
                                              <button type="submit" name="restrict_btn" class="hbtn hb-fill-right-rev-bg-br"><span class="fa fa-ban"></span> Restrict</button>
                        </form>
                        <form action="./admin_subjects/list1.php" method="post">
                                              <input type="hidden" name="view_id" value="<?php echo $stu_id; ?>">
