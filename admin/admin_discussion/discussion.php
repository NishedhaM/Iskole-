        ...
        <div class="main-content">
            ...
            <main>
                ...
                <!-- <select  style="margin-left:-900px;"onchange="la(this.value)">
                                    ...
                                    <option value="../../../admin_subjects/mathematics/grade5/subjectindex.php">Grade2</option>
                                    <option value="../../../admin_subjects/mathematics/grade3/subjectindex.php">Grade3</option>
                                    <option value="../../../admin_subjects/mathematics/grade1/subjectindex.php">Grade4</option>
                                    <option value="../../../admin_subjects/mathematics/grade2/subjectindex.php">Grade5</option>
                            ...
                            foreach ($rows as $row) :
                                ...
                                $query = "SELECT * FROM members where id='$id' ";
                                        ...
                                        if($result = mysqli_query($connection,$query)){
                                            ...
                                            ?>
                                            <ol>
                                            <li><span style="margin-left: 0px;" class="las la-user-circle"></span><a href=""><?php echo $first_name;?>&nbsp;<?php echo $last_name;?>
                                            </li>
