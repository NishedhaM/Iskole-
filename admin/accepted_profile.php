            ...
            <main>
                <div class="page-header">
                    <div class="dpandname">
                           ...
                           <img id="teacherprofile" src="<?php echo $image_src_tea;  ?>">
                    ...
                    <div class="header-actions">
                        <form action="restrict.php" method="post">
                                                <input type="hidden" name="restrict_id" value="<?php echo $id; ?>">
                                                <button type="submit" name="restrict_btn" class="hbtn hb-fill-right-rev-bg-br"><span class="fa fa-ban"> Restrict</button>
                        </form>
                        <form action="./admin_subjects/list.php" method="post">
                                              <input type="hidden" name="view_id" value="<?php echo $id; ?>">
                                              <button type="submit" name="view_btn" class="hbtn hb-fill-right-rev-bg-br"><span class="las la-tools"></span> Statistics</button>
                        </form>
                ...
                <div class="container">
                    ...
                    <div class="main2">
                        <div class="gr3">
                            ...
                            <?php
                            $q="SELECT * FROM teacher_qualification_pdf WHERE teacher_id=$id ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                                            ...
                                            echo "<br>";
                                        ?>
                             <a href="./admin_unregistered/upload/<?php echo $row['proof_name'];?>" target="blank" >
                            ...
                            <form action="./admin_analytics/change_course.php" method="post">
                                                  <input type="hidden" name="view_id" value="<?php echo $id; ?>">
                                                  <button type="submit" name="view_btn" class="hbtn hb-fill-right-rev-bg-br"><span class="las la-tools"></span> Change Course</button>
                            </form>
                        </div>
