...
<head>
    ...
    <title>Teacher Waiting list</title>
            ...
            <main>
                ...
                <div class="container">
                    ...
                    <?php
                      ...
                      if(isset($_POST['submit'])){
                          if(!empty($_POST['Grade'])) {
                              if(!empty($_POST['Subject'])) {
                                ...
                                $query = "SELECT * FROM `members` WHERE status='pending' AND type='teacher' AND id IN(SELECT teacher_id FROM `teacher_grade_subject` WHERE gid='$grade' AND sid='$sub')";
                                ...
                                <table>
                                    ...
                                    <td>
                                        <form action="../waiting_profile.php" method="post">
                      ...
                      $query = "SELECT * FROM `members` WHERE status='pending' AND type='teacher'";
                        $query_run = mysqli_query($connection, $query);
