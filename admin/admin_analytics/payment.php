...
<head>
    ...
    <title><?php echo $first_name; ?>&nbsp;<?php echo $last_name; ?> &nbsp; Payment </title>
        ...
        <div class="main-content">
            ...
            <main>
                <div class="page-header">
                    <div>
                        <h3>
                            <?php echo $first_name; ?>&nbsp;<?php echo $last_name; ?> &nbsp; Payment
                ...
                <div class="container">
                    ...
                    //echo $end;
                                      ...
                                      $connection = mysqli_connect("localhost","root","","demo");
                                      $query = "SELECT gid  FROM teacher_grade_subject  where teacher_id=$id GROUP BY gid ";
                                      ...
                                      $sql= "SELECT price FROM grade where gid='$grade'";
                                          $query_run = mysqli_query($connection, $sql);
                                            ...
                                            if($result = mysqli_query($connection,$query)){
                                              ...
                                              $query ="SELECT sid  FROM teacher_grade_subject where teacher_id=$id AND gid='$grade'" ;
                                              $rows = mysqli_query($connection,$query);
