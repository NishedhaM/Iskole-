...
<head>
    ...
    <title><?php echo $first_name; ?>&nbsp;<?php echo $last_name; ?> &nbsp; Chat History </title>
        ...
        <div class="main-content">
            ...
            <main>
                <div class="page-header">
                    <div>
                        <h3>
                            <?php echo $first_name; ?>&nbsp;<?php echo $last_name; ?> &nbsp; Chat History
                ...
                <div class="container">
                    ...
                    <?php
                      ...
                      $query = "SELECT * FROM `messages` WHERE incoming_msg_id=$id OR outgoing_msg_id=$id";
                      $query_run = mysqli_query($connection, $query);
