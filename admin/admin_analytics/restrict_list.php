...
<head>
    ...
    <title>Restricted Teachers</title>
        ...
        <div class="main-content">
            ...
            <main>
                <div class="page-header">
                    <div>
                        <h3>
                            Restricted Teachers <?php echo $cdate ?>
                        </h3>
                    </div>
                ...
                <div class="container">
                    ...
                    <?php
                      ...
                      $query = "SELECT * FROM `members` WHERE status='restrict' AND type='teacher' ORDER BY restricted_date ASC";
                    ...
                    <table>
                        ...
                        <td><?php  echo $row['restricted_date']; ?></td>
                        <td>
                            <form action="../restrict_profile.php" method="post">
