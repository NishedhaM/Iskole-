    ...
    <div class="sidebar">
        ...
        <div class="sidebar-main">
            <div class="sidebar-user">
                <a href="../teacher_upload qualifications/uploadqualification.php"><img src="img/teacher2.jpg"  alt=""></a>
                 <div>
         ...
         <div class="sidebar-menu">
               ...
               <ul>
                  ...
                  <li><a href="../teacher_upload qualifications/uploadqualification.php">
                  ...
                  <li><a href="../teacher_upload qualifications/uploadqualification.php"><span class="las la-users"></span>My Students</a></li>

                  <li><a href="../teacher_upload qualifications/uploadqualification.php"><span class="las la-check-circle"></span>Tasks</a>
                  </li>
                   
                   <li><a href="../teacher_upload qualifications/uploadqualification.php"><span class="las la-chart-pie"></span>Analytics</a></li>
                   ...
                   <li>
                   <a href="../teacher_upload qualifications/uploadqualification.php">
                  ...
                  <li><a href="../teacher_upload qualifications/uploadqualification.php"><span class="las la-comments"></span>Chat</a></li>
