        ...
        <div class="sidebar-main">
         ...
         <div class="sidebar-menu">
                 ...
                 <ul>
                    ...
                    <li>
                     <a href="../teacher_discussion/exhibition.php">
            ...
            <main>
                <div class="page-header">
                    ...
                    <div class="header-actions">
                        <a href="./quiz.php" class="hbtn hb-fill-right-rev-bg-br"><span class="las la-tools"></span>Back</a>
                ...
                <div class="container">
                    ...
                    <div class="group2">
                        ...
                        <!-- <button id="submit" name="submit">Send</button> -->
                                ...
                                <input style="margin-left: 20px; width: 100px; height: 20px;margin-top: 70px;" type="text2" placeholder="Numbers" name="unit" id="unit"   >
