        ...
        <div class="main-content">
            ...
            <?php
              ...
              ?>
                ...
                <button class="button" type="submit" id="S1" name="S1" value="S1" >Mathematics</button>
...
<?php
              ...
              {$grade=$_POST['grade1'];
                ...
                <input type="hidden" name="grade_id" value="<?php echo $grade; ?>">
                <button class="button" type="submit" id="S3" name="S3" value="S3" >Sinhala</button>
...
<?php
              ...
              ?>
                ...
                <input type="hidden" name="grade_id" value="<?php echo $grade; ?>">
                <button class="button" type="submit" id="S2" name="S2" value="S2" >English</button>
...
<?php
              if(isset($_POST['grade1']))
              {$grade=$_POST['grade1'];?>
                <form action="./quiz_aesthetic/quiz.php" method="post">
                <input type="hidden" name="grade_id" value="<?php echo $grade; ?>">
                <button class="button" type="submit" id="S4" name="S4" value="S4" >Aesthetic</button>
...
<?php
              ...
              {$grade=$_POST['grade1'];?>
                ...
                <input type="hidden" name="grade_id" value="<?php echo $grade; ?>">
                <button class="button" type="submit" id="S5" name="S5" value="S5" >Environmental science</button>
