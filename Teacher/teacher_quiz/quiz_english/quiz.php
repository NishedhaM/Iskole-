...
date_default_timezone_set('Asia/Colombo'); 
  ...
  /*last quiz id*/
   $query ="SELECT qid  FROM quizz ORDER BY uploaded_date DESC LIMIT 1 " ;
   ...
   //    $ans=trim($_POST['ans']);
      ...
      $query = " INSERT INTO `quizz` (`qid`, `sid`, `gid`, `uid`, `q_title`, `teacher_id`, `uploaded_date`) VALUES ('$qid', 'S2', '$Grade_new', 'U1', '$q_title', $_SESSION[id], '$date');";
...
<body>
  <div class="nav-container">
    <div class="logo">
      <img src="../../teacher_images/logo.png" align="right" height="80px" width="80px" >
    </div> 
    ...
    <div class="qa_body">
        <div class="qa_set active">
          ...
          <!-- <button id="submit" name="submit">Send</button> -->
              ...
              <input type="text1" placeholder="Untitled Form" name="q_title" id="q_title" required><br>
              <p><?php  echo $q_id ?></p>
              ...
              <select id="Grade" name="Grade">
                <?php
                $sql= "SELECT gid FROM teacher_grade_subject where  teacher_id=$_SESSION[id] AND sid='S1' ";
