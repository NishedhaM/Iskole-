...
$connection = mysqli_connect("localhost","root","","demo");
     ...
     $sql= "SELECT COUNT(id)  AS count FROM members  where type='teacher' AND status='accepted'   ";
     ...
     $sql= "SELECT COUNT(id)  AS count3 FROM members  where type='admin' ";
        $query_run = mysqli_query($connection, $sql);
        if($result = mysqli_query($connection,$sql)){
                      if(mysqli_num_rows($result) > 0){
                            while($row = mysqli_fetch_array($result)){
    ...
    $sql= "SELECT name FROM images where  member_id=$_SESSION[id] ";
     ...
     $sql= "SELECT COUNT(sid)  AS count_sid FROM teacher_grade_subject  where teacher_id=$_SESSION[id] ";
        $query_run = mysqli_query($connection, $sql);
            if($result = mysqli_query($connection,$sql)){
                          if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                 $count_sid= $row['count_sid'];
                                    }
                                  }
                                }
        ...
        <div class="sidebar-main">
         ...
         <div class="sidebar-menu">
                 ...
                 <ul>
                    ...
                    <li>
                     <a href="../child/Exhibition/child_exhi.php">
            ...
            <main>
                    ...
                    <div class="card-single">
                        <div class="card-flex">
                            <div class="card-info">
                                ...
                                <div class="card-head">
                                    <a href=""><span>My Students</span></a>
                                ...
                                <?php     
                                                            ...
                                                            //  echo $row['gid'];
                                                                ...
                                                                $query ="SELECT count(student_id) AS count5,student_id  FROM paid_items where  gid='$grade' AND valid_till>='$date'  " ;
                                                                    $rows = mysqli_query($connection,$query);
                                                                    ...
                                                                    endforeach;
                                                                     $count2=$count2+$count5;
                                                                    

                                                                  
                                                                    endforeach;?>
                                                                    <h2><?php echo $count2;?></h2><?php
                    ...
                    <div class="card-single">
                        <div class="card-flex">
                            <div class="card-info">
                                ...
                                <div class="card-head">
                                <a href="./teacher_details/teacherdetails.php">
                    ...
                    <div class="card-single">
                        <div class="card-flex">
                            <div class="card-info">
                                ...
                                <div class="card-head">
                                <a href="./admindetails/admindetails.php">
                                    <span>Admins</span></a>
                ...
                <div class="jobs-grid">
                    <div class="analytics-card">
                        ...
                        <div class="analytics-chart">
                            <div class="chartandbox">
                                <div class="chartsubject">
                                    ...
                                    <select name="Grade" class="box3-subject">
                                ...
                                <div name="Subject" class="gradesubject">
                        ...
                        <button  id="btnlast" name="btnlast"><a href="./teacher_generated_report.php">Generate report</a></button></div>
                        </form>
                    </div>
                    ...
                    <h3>Uploads<small> Recently Updates </small></h3> 
                        ...
                        <table>
                            <tbody>
                                ...
                                $query ="SELECT * FROM video where teacher_id=$_SESSION[id] ORDER BY id DESC LIMIT 4";
                            ...
                            foreach ($rows as $row) : 
                                ...
                                $query = "SELECT * FROM members where id='$id' ";
                                        ...
                                        if($result = mysqli_query($connection,$query)){
                                            ...
                                            ?>
                                            <ol>
                                            <li><span style="margin-left: 0px;" class="las la-user-circle"></span><a href="./teacher_profile_other.php"><?php echo $first_name;?>&nbsp;<?php echo $last_name;?>  </a><img src="img/speech-bubble.svg">
                                            </li>
                ...
                <div class="calendarandupdates">
                    <div class="calendar">
                    <div class="month">
                    <i style="margin-left:-300px" class="fas fa-angle-left prev"></i>
                    <div class="date">
                        <h1></h1>
                        <p></p>
                    </div>
                    <i style="margin-right: -180px;" class="fas fa-angle-right next"></i>
                    </div>
                    <div class="weekdays">
                    <div>Sun</div>
                    <div>Mon</div>
                    ...
                    <?php
                    $query = "SELECT * FROM tbl_events where teacher_id='$_SESSION[id]' ORDER BY start DESC LIMIT 4 ";
                    $query_run = mysqli_query($connection, $query);
                    if($result = mysqli_query($connection,$query)){
                        if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_array($result)){
                        ...
                        <table width="100">
                            <tr>
                                ...
                                <td ><div style="padding-left: 24px;"><?php echo $title;  ?></div></td>
                                <td><div style="padding-left: 20px;">          </</div></td>
                                <td><div style="padding-left: 10px;"><button id="btnlast">
                                  <a style="color:white;" href="./teacher_calendar/calendar_0/index.php" >View</a>
                                </button ></div></td>
                            </tr>
                        </table>
                        </div>
