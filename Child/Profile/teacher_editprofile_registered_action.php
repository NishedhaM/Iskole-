...
if(isset($_POST['but_upload'])){
    ...
    $target_dir = "imgp/";
    $target_dir1="../../Teacher/teacher_upload/upload/";
         ...
         // Insert record
          ...
          // $sql = "select name from images where id='$_SESSION[id]'";
            ...
            if(mysqli_num_rows($result) > 0){
               ...
               echo '<script>showAlert();window.setTimeout(function () {HideAlert();},3000);</script>';  echo "<meta http-equiv='refresh' content='0;url=teacher_editprofile_registered.php'>";  
