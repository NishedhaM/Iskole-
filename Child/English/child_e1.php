...
<link rel="stylesheet" href="child_e1.css" type="text/css" />
</head>
<body>
<div class="nav-container">
  <br><br>
      ...
      <h1 class="title" align="center"> English-Homework</h1>
...
<div class="row">
  ...
  <div class="backbtn">
  <form action="child_eng.php" method="post">
...
<table width="80%" border="1">
    ...
    <?php
 $sql="SELECT * FROM video WHERE gid='$id' AND sid='S2' AND content_type='pdf'";
