...
<head>
    ...
    <link rel="stylesheet" href="child_env2.css">
...
<div class="nav-container">
    ...
    <a href="child>discussion.php"><img src="../images/notifications.png" height="30px" width="30px"/></a> 
          ...
          <h1 class="title" align="center"> Environmental Studies-Videos
          </h1>
...
//    echo $id;
   ...
   <form action="child_env.php" method="post">
    ...
    <button type="submit" name="view_btn" class="btn1"> <img src="../images/back.png" height="80px" width="60px"> 
            ...
            <?php
            include("db.php");
            $q="SELECT * FROM video WHERE gid='$id' AND sid='S5' AND uid='U1' AND content_type='mp4'";
