    ...
    <div class="container">
       ...
       if(isset($_POST['view_btn']))
       {
        ...
        //    echo $id;
           ...
           ?>
           <div class="backbtn">
           <form action="child_sinhala.php" method="post">
        ...
        <h1 class="title" align="center"> සිංහල-පාඩම්</h1>
            <?php
            include("db.php");
            $q="SELECT * FROM video WHERE gid='$id' AND sid='S3' AND uid='U1' AND content_type='mp4'";
