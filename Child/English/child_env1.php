...
<link rel="stylesheet" href="child_env1.css" type="text/css" />
</head>
<body>
<div class="nav-container">
      ...
      <!-- <a href="child_env.php"> <button class="btn1"><img src="images/back.png" height="80px" width="60px">  </button></a>
        -->
      ...
      <a href="child>discussion.php"><img src="images/notifications.png" height="30px" width="30px"/></a> 
          ...
          <h1 class="title" align="center"> Environmental Studies-Homework
          </h1>
...
//    echo $id;
   ...
   ?>
   <div class="backbtn">
   <form action="child_env.php" method="post">
...
<!-- <th colspan="4">your uploads...<label><a href="upload.php">upload new files...</a></label></th> -->
 <table width="80%" border="1">
    ...
    <?php
 $sql="SELECT * FROM video WHERE gid='$id' AND sid='S5' AND content_type='pdf'";
