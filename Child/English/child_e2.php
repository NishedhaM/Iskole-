...
<head>
    ...
    <link rel="stylesheet" href="child_e2.css">
...
<br>  
    ...
    <div class="container">
       ...
       if(isset($_POST['view_btn']))
       {
        ...
        <h1 class="title" align="center"> English-Lessons</h1>
            <?php
            include("db.php");
            $q="SELECT * FROM video WHERE gid='$id' AND sid='S2' AND uid='U1' AND content_type='mp4'";
